...
class PreferenceFrame(wx.Frame):
    ...
    def __init__(self, app, parent=None):
        ...
        panelSizer = wx.FlexGridSizer(
            14, 2, metrics.size("relatedControls"), metrics.size("relatedControls")
        )
        ...
        self.editorFont.Bind(
            wx.EVT_FONTPICKER_CHANGED,
            lambda e: self.saveFontPref("windowed", self.editorFont.GetSelectedFont()),
        )
        ...
        self.monoFont.Bind(
            wx.EVT_FONTPICKER_CHANGED,
            lambda e: self.saveFontPref("monospace", self.monoFont.GetSelectedFont()),
        )
        ...
        self.fsFont.Bind(
            wx.EVT_FONTPICKER_CHANGED,
            lambda e: self.saveFontPref("fs", self.fsFont.GetSelectedFont()),
        )

        self.fsTextColor = wx.ColourPickerCtrl(panel)
        self.fsTextColor.SetColour(self.app.config.Read("fsTextColor"))
        self.fsTextColor.Bind(
            wx.EVT_COLOURPICKER_CHANGED,
            lambda e: self.savePref("fsTextColor", self.fsTextColor.GetColour()),
        )
        ...
        self.fsBgColor.Bind(
            wx.EVT_COLOURPICKER_CHANGED,
            lambda e: self.savePref("fsBgColor", self.fsBgColor.GetColour()),
        )
        ...
        self.fsLineHeight = wx.ComboBox(
            fsLineHeightPanel, choices=("100", "125", "150", "175", "200")
        )
        self.fsLineHeight.Bind(
            wx.EVT_TEXT,
            lambda e: self.savePref("fsLineHeight", int(self.fsLineHeight.GetValue())),
        )
        ...
        fsLineHeightSizer.Add(
            wx.StaticText(fsLineHeightPanel, label="%"), flag=wx.ALIGN_CENTER_VERTICAL
        )
        ...
        def checkbox(self, name, label, panel=panel):
            ...
            attr.Bind(
                wx.EVT_CHECKBOX,
                lambda e, name=name, attr=attr: self.savePref(name, attr.GetValue()),
            )
        ...
        checkbox(
            self, "createPassagePrompt", "Offer to create new passages for broken links"
        )
        ...
        panelSizer.Add(
            wx.StaticText(panel, label="Normal Font"), flag=wx.ALIGN_CENTER_VERTICAL
        )
        panelSizer.Add(self.editorFont)
        panelSizer.Add(
            wx.StaticText(panel, label="Monospace Font"), flag=wx.ALIGN_CENTER_VERTICAL
        )
        panelSizer.Add(self.monoFont)
        panelSizer.Add(
            wx.StaticText(panel, label="Fullscreen Editor Font"),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        panelSizer.Add(self.fsFont)
        panelSizer.Add(
            wx.StaticText(panel, label="Fullscreen Editor Text Color"),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        panelSizer.Add(self.fsTextColor)
        panelSizer.Add(
            wx.StaticText(panel, label="Fullscreen Editor Background Color"),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        panelSizer.Add(self.fsBgColor)
        panelSizer.Add(
            wx.StaticText(panel, label="Fullscreen Editor Line Spacing"),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        panelSizer.Add((1, 2))
        panelSizer.Add(
            wx.StaticText(panel, label="When closing a passage:"),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        panelSizer.Add((1, 2))
    ...
    def getPrefFont(self, key):
        ...
        """
        return wx.Font(
            self.app.config.ReadInt(key + "FontSize"),
            wx.FONTFAMILY_MODERN,
            wx.FONTSTYLE_NORMAL,
            wx.NORMAL,
            False,
            self.app.config.Read(key + "FontFace"),
        )
